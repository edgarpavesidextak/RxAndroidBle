...
On Android it is not always trivial to determine if a particular BLE operation has a potential to succeed. e.g. to scan on Android 6.0 the device needs to have a `BluetoothAdapter`, the application needs to have a granted [runtime permission](https://github.com/edgarpavesidextak/RxAndroidBle#permissions) for either `ACCESS_COARSE_LOCATION` or `ACCESS_FINE_LOCATION`, additionally `Location Services` need to be turned on.
...
### Helpers
We encourage you to check the package [`com.polidea.rxandroidble2.helpers`](https://github.com/edgarpavesidextak/RxAndroidBle/tree/master/rxandroidble/src/main/java/com/polidea/rxandroidble2/helpers) and [`com.polidea.rxandroidble2.utils`](https://github.com/edgarpavesidextak/RxAndroidBle/tree/master/rxandroidble/src/main/java/com/polidea/rxandroidble2/utils) which contain handy reactive wrappers for some typical use-cases.
...
- [`/sample`](https://github.com/edgarpavesidextak/RxAndroidBle/tree/master/sample/src/main/java/com/polidea/rxandroidble2/sample)
- [`/sample-kotlin`](https://github.com/edgarpavesidextak/RxAndroidBle/tree/master/sample-kotlin/src/main/kotlin/com/polidea/rxandroidble2/samplekotlin)
...
### Integration tests
Sometimes there is a need to develop the application without the access to a physical device. We have created [MockRxAndroidBle](https://github.com/edgarpavesidextak/RxAndroidBle/tree/master/mockrxandroidble) as a drop-in addon for mocking a simple peripheral.

Unfortunately it is not under active development—PRs are welcomed though. ;)

## [Small performance comparison](https://github.com/edgarpavesidextak/RxAndroidBle/issues/41#issuecomment-333513707)
...
- [Cannot connect / Status 133](https://github.com/edgarpavesidextak/RxAndroidBle/wiki/FAQ:-Cannot-connect)
- [UndeliverableException](https://github.com/edgarpavesidextak/RxAndroidBle/wiki/FAQ:-UndeliverableException)
...
## Maintainers
* Edgar Pavesi (github: edgarpavesidextak)

## [Contributors](https://github.com/edgarpavesidextak/RxAndroidBle/graphs/contributors), thank you!
